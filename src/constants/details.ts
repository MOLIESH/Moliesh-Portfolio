export const title =
  "MOLIESH Portfolio - Full-Stack Developer | UI/UX Design & Web Solutions";
export const description =
  "Discover MOLIESH's portfolio, a full-stack developer specializing in UI/UX design, front-end, and back-end development. Explore innovative web solutions.";
